<template>
    <div class="orgManagement">
        <div class="left">
            <div class="button" style="margin-bottom: 18px" align="left">
                <el-button type="primary" size="small">新增</el-button>
                <el-button type="danger" size="small">删除</el-button>
            </div>
            <div class="query">
                <el-input v-model="queryform.orgName" placeholder="请输入机构名称" style="flex-grow: 1;">
                    <el-button slot="append" icon="el-icon-search"></el-button>
                </el-input>
                <!-- <el-button type="primary" size="small"  style="flex-grow: 0; flex-shrink: 0;">查询</el-button> -->
            </div>
            <el-table :data="tableData" size="mini" :highlight-current-row="true" style="margin-bottom: 10px; border: 0;" :cell-style="{border: 'none'}" height="calc(100% - 84px)">
        ...
        <div class="right">
            <div class="btn">
                <el-button v-if="!edited" type="primary" size="small" @click="edited = true">编辑</el-button>
                <el-button v-if="edited" type="success" size="small" @click="edited = false">保存</el-button>
                <el-button v-if="edited" size="small" @click="edited = false">取消</el-button>
            </div>
            <el-form :model="form" :rules="rules" ref="form" status-icon label-width="100px" class="demo-ruleForm" size="small">
                <fieldset class="layui-elem-field">
                    ...
                    <el-form-item label="所属地区" prop="selectCity">
                        <el-cascader expand-trigger="hover" :props="cityProps" :options="cityOptions" v-model="form.selectCity"></el-cascader>
                    </el-form-item>
...
export default {
    ...
    data() {
		return {
            queryform: {},
            tableData: [
                {orgName:"佛山楼宇1", orgDesc:"佛山楼宇1", orgAddress:"滨江区1509号滨江区1509号滨江区1509号滨江区1509号滨江区1509号滨江区1509号滨江区1509号滨江区1509号", contacts:"徐鑫鑫", contactsNum:"18799990000",},
                {orgName:"佛山楼宇1", orgDesc:"佛山楼宇1", orgAddress:"滨江区1509号", contacts:"徐鑫鑫", contactsNum:"18799990000",},
                {orgName:"佛山楼宇1", orgDesc:"佛山楼宇1", orgAddress:"滨江区1509号", contacts:"徐鑫鑫", contactsNum:"18799990000",},
                {orgName:"佛山楼宇1", orgDesc:"佛山楼宇1", orgAddress:"滨江区1509号", contacts:"徐鑫鑫", contactsNum:"18799990000",},
                {orgName:"佛山楼宇1", orgDesc:"佛山楼宇1", orgAddress:"滨江区1509号", contacts:"徐鑫鑫", contactsNum:"18799990000",},
                {orgName:"佛山楼宇1", orgDesc:"佛山楼宇1", orgAddress:"滨江区1509号", contacts:"徐鑫鑫", contactsNum:"18799990000",},
...
<style>
    ...
    .orgManagement .left, .orgManagement .right{
        height: 100%;
        padding: 10px 20px; 
    ...
    .orgManagement .left .query{
        display: flex;
        margin-bottom: 10px;
    }
    .orgManagement .left .el-table__header-wrapper{
        display: none;
    ...
    .orgManagement .layui-elem-field legend {
        margin-left: 20px;
        padding: 0 10px;
        font-weight: 700;
        font-size: 16px;
    ...
    .orgManagement .layui-elem-field{
        padding-right: 20px;
        margin-bottom: 20px;
