<template>
    <div class="menuManagement" style="height: 100%; padding: 10px 20px; box-sizing: border-box; background: #fff;">
        <el-tabs style="font-size: 14px; height: 100%">
            <el-tab-pane label="菜单权限">
                ...
                <!-- <el-table :data="menuTableData" border size="mini" height="calc(100% - 42px)">
                    <el-table-column label="菜单名" prop="menuName" align="left"></el-table-column>
                    <el-table-column label="菜单链接" prop="menuUrl" align="center"></el-table-column>
                    <el-table-column label="菜单图标" prop="menuIcon" align="center"></el-table-column>
                    <el-table-column label="排序" prop="menuOrder" align="center"></el-table-column>
                ...
                <!-- <div class="treeTable el-table el-table--fit el-table--border el-table--scrollable-y el-table--enable-row-hover el-table--enable-row-transition el-table--small" style="height: calc(100% - 42px)">
                            ...
                            <thead class="has-gutter">
                                <tr>
                                    <th class="is-center" width="20%">
                                        <div class="cell">菜单名</div>
                                    </th>
                                    <th class="is-center" width="25%">
                                        <div class="cell">菜单链接</div>
                                    </th>
                                    <th class="is-center" width="20%">
                                        <div class="cell">菜单图标</div>
                                    </th>
                    ...
                    <div class="el-table__body-wrapper is-scrolling-none" style="height: calc(100% - 41px)">
                        <table v-for="item in menuTableData" cellspacing="0" cellpadding="0" border="0" class="el-table__body" style="width: 100%">
                            <tbody>
                                <tr class="el-table__row">
                                    <td class="is-left" width="20%">
                                        <div class="cell">
                                            <span v-if="item.menuList && item.menuList.length > 0">
                                    ...
                                    <td class="is-center" width="25%">
                                        <div class="cell">{{item.menuUrl}}</div>
                                    </td>
                                    <td class="is-center" width="20%">
                                        
                                    </td>
                                    <td class="is-center" width="15%">
                                        <div class="cell">{{item.menuOrder}}</div>
                                    </td>
                                    <td class="is-center" width="20%">
                                        <el-button type="primary" plain icon="el-icon-edit" size="mini"></el-button>
                                        <el-button type="danger" plain icon="el-icon-delete" size="mini"></el-button>
                            ...
                            <tbody v-show="!item.unShowList" v-for="child in item.menuList" class="secondList">                                
                                <tr class="el-table__row">
                                    <td class="is-left" width="20%">
                                        <div class="cell">
                                            <span v-if="child.menuList && child.menuList.length > 0">
                                    ...
                                    <td class="is-center" width="25%">
                                        <div class="cell">{{child.menuUrl}}</div>
                                    </td>
                                    <td class="is-center" width="20%">
                                        
                                    </td>
                                    <td class="is-center" width="15%">
                                        <div class="cell">{{child.menuOrder}}</div>
                                    </td>
                                    <td class="is-center" width="20%">
                                        <el-button type="primary" plain icon="el-icon-edit" size="mini"></el-button>
                                        <el-button type="danger" plain icon="el-icon-delete" size="mini"></el-button>
                                ...
                                <tr v-show="!child.unShowList" v-for="third in child.menuList" class="table__row thirdList">
                                    <td class="is-left" width="20%">
                                        <div class="cell">
                                            {{third.menuName}}
                                        </div>
                                    ...
                                    <td class="is-center" width="25%">
                                        <div class="cell">{{third.menuUrl}}</div>
                                    </td>
                                    <td class="is-center" width="20%">
                                        
                                    </td>
                                    <td class="is-center" width="15%">
                                        <div class="cell">{{third.menuOrder}}</div>
                                    </td>
                                    <td class="is-center" width="20%">
                                        <el-button type="primary" plain icon="el-icon-edit" size="mini"></el-button>
                                        <el-button type="danger" plain icon="el-icon-delete" size="mini"></el-button>
            ...
            <el-tab-pane label="按钮权限">
                ...
                <!--
                <el-table :data="btnTableData" border size="mini" height="calc(100% - 42px)">
                    <el-table-column type="expand" width="50">
                        <template slot-scope="scope">
                            <el-table :data="scope.row.btnList" class="inside">
                                <el-table-column type="expand" width="50"></el-table-column>
                                <el-table-column label="父级菜单名 / 按钮名" prop="btnName" align="center"></el-table-column>
                                <el-table-column label="按钮别名" prop="btnAlias" align="center"></el-table-column>
                                <el-table-column label="按钮链接" prop="btnUrl" align="center"></el-table-column>
                                <el-table-column label="按钮方法" prop="btnMethod" align="center"></el-table-column>
                                <el-table-column label="操作" align="center">
                                    <template slot-scope="scope">
                                        <el-button type="primary" plain icon="el-icon-edit" size="mini"></el-button>
                                        <el-button type="danger" plain icon="el-icon-delete" size="mini"></el-button>
                    ...
                    <el-table-column label="父级菜单名 / 按钮名" prop="menuName" align="center"></el-table-column>
                    <el-table-column label="按钮别名" prop="menuUrl" align="center"></el-table-column>
                    <el-table-column label="按钮链接" prop="menuIcon" align="center"></el-table-column>
                    <el-table-column label="按钮方法" prop="menuOrder" align="center"></el-table-column>
                    <el-table-column label="操作" align="center">
                        <template slot-scope="scope">
                            <el-button type="primary" plain icon="el-icon-edit" size="mini"></el-button>
                            <el-button type="danger" plain icon="el-icon-delete" size="mini"></el-button>
                ...
                <!-- <div class="treeTable el-table el-table--fit el-table--border el-table--scrollable-y el-table--enable-row-hover el-table--enable-row-transition el-table--small" style="height: calc(100% - 42px)">
                    <div class="el-table__header-wrapper">
                        <table class="el-table__header" cellspacing="0" cellpadding="0" border="0" style="width: 100%">
                            <thead class="has-gutter">
                                <tr>
                                    <th class="is-center" width="20%">
                                        <div class="cell">父级菜单名 / 按钮名</div>
                                    </th>
                                    <th class="is-center" width="15%">
                                        <div class="cell">按钮别名</div>
                                    </th>
                                    <th class="is-center" width="20%">
                                        <div class="cell">按钮链接</div>
                                    </th>
                                    <th class="is-center" width="25%">
                                        <div class="cell">按钮方法</div>
                                    </th>
                                    <th class="is-center" width="20%">
                                        <div class="cell">操作</div>
                                    </th>
                    ...
                    <div class="el-table__body-wrapper is-scrolling-none" style="height: calc(100% - 41px)">
                        <table v-for="item in btnTableData" cellspacing="0" cellpadding="0" border="0" class="el-table__body" style="width: 100%">
                            <tbody>
                                <tr class="el-table__row">
                                    <td class="is-left" width="20%">
                                        <div class="cell">
                                            <span v-if="item.btnList && item.btnList.length > 0">
                                                <i v-show="item.unShowList" class="el-icon-caret-right" @click="item.unShowList = false"></i>
                                                <i v-show="!item.unShowList" class="el-icon-caret-bottom" @click="item.unShowList = true"></i>
                                            </span>
                                            {{item.menuName}}
                            ...
                            <tbody v-show="!item.unShowList" v-for="child in item.btnList" class="secondList">                                
                                <tr class="el-table__row">
                                    <td class="is-left" width="20%">
                                        <div class="cell">
                                            <span v-if="child.btnList && child.btnList.length > 0">
                                                <i v-show="child.unShowList" class="el-icon-caret-right" @click="child.unShowList = false"></i>
                                                <i v-show="!child.unShowList" class="el-icon-caret-bottom" @click="child.unShowList = true"></i>
                                            </span>
                                            {{child.btnName}}
                                    ...
                                    <td class="is-center" width="20%">
                                        ...
                                        <div class="cell">{{child.btnUrl}}</div>                                        
                                    </td>
                                    <td class="is-center" width="25%">
                                        
                                        <div class="cell">{{child.btnMethod}}</div>
                                    </td>
                                    <td class="is-center" width="20%">
                                        <el-button type="primary" plain icon="el-icon-edit" size="mini"></el-button>
                                        <el-button type="danger" plain icon="el-icon-delete" size="mini"></el-button>
        ...
        <el-dialog title="创建/更新菜单":visible.sync="menuDialogVisible" :close-on-click-modal=false :close-on-press-escape=false width="400px">
            <el-form :model="menuForm" size="small" label-width="80px">
                ...
                <el-form-item label="菜单链接" prop="menuUrl">
                    <el-input v-model="menuForm.menuUrl" placeholder="请输入菜单链接"></el-input>
                </el-form-item>
        ...
        <el-dialog title="创建/更新按钮":visible.sync="btnDialogVisible" :close-on-click-modal=false :close-on-press-escape=false width="400px">
            <el-form :model="btnForm" size="small" label-width="80px">
                ...
                <el-form-item label="按钮别名" prop="btnAlias">
                    <el-input v-model="btnForm.btnAlias" placeholder="请输入按钮别名"></el-input>
                </el-form-item>
                <el-form-item label="按钮链接" prop="btnUrl">
                    <el-input v-model="btnForm.btnUrl" placeholder="请输入按钮链接"></el-input>
                </el-form-item>
                <el-form-item label="方法名" prop="btnMethod">
                    <el-input v-model="btnForm.btnMethod" placeholder="请输入方法名"></el-input>
                </el-form-item>
                <el-form-item label="所属菜单">
                    <el-select v-model="btnForm.menuId" placeholder="选择所属菜单" style="width: 100%;">
                        <el-option v-for="item in btnMenuList" :key="item.menuId" value="item.menuId" label="item.name" align="left"></el-option>
                    </el-select>
                </el-form-item>
            </el-form>
            <span slot="footer">
...
<style>
.menuManagement .el-tabs__content{
    height: calc(100% - 55px);
}
.menuManagement .el-tab-pane{
    height:100%;
}
.menuManagement .secondList .is-left .cell{
    margin-left: 40px;
}
.menuManagement .thirdList .is-left .cell{
    margin-left: 80px;
}
.menuManagement .el-dialog__body{
    padding: 10px 20px 0;
}
.menuManagement .el-table__expanded-cell{
    padding: 0;
}
.menuManagement .inside th{
    display: none;
}
</style>
